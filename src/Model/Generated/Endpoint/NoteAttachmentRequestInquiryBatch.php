 ...
 * @generated
 */
class NoteAttachmentRequestInquiryBatch extends BunqModel
{
    /**
     * Endpoint constants.
     */
    const ENDPOINT_URL_CREATE = 'user/%s/monetary-account/%s/request-inquiry-batch/%s/note-attachment';
    const ENDPOINT_URL_UPDATE = 'user/%s/monetary-account/%s/request-inquiry-batch/%s/note-attachment/%s';
    const ENDPOINT_URL_DELETE = 'user/%s/monetary-account/%s/request-inquiry-batch/%s/note-attachment/%s';
    const ENDPOINT_URL_LISTING = 'user/%s/monetary-account/%s/request-inquiry-batch/%s/note-attachment';
    const ENDPOINT_URL_READ = 'user/%s/monetary-account/%s/request-inquiry-batch/%s/note-attachment/%s';
    ...
    /**
     * @param int $requestInquiryBatchId
     * @param int $noteAttachmentRequestInquiryBatchId
     * @param int|null $monetaryAccountId
     * @param string|null $description Optional description of the attachment.
     * @param string[] $customHeaders
     *
    ...
    public static function listing(
        ...
        return BunqResponseNoteAttachmentRequestInquiryBatchList::castFromBunqResponse(
    ...
    public static function get(
        ...
        return BunqResponseNoteAttachmentRequestInquiryBatch::castFromBunqResponse(
