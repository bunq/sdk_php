...
class NoteAttachmentRequestResponse extends BunqModel
{
    ...
    public static function update(
        int $requestResponseId,
        int $noteAttachmentRequestResponseId,
        int $monetaryAccountId = null,
        string $description = null,
        array $customHeaders = []
    ): BunqResponseInt {
        ...
        $responseRaw = $apiClient->put(
            vsprintf(
                ...
                [
                    ...
                    $requestResponseId,
                    $noteAttachmentRequestResponseId,
                ]
            ),
            [self::FIELD_DESCRIPTION => $description],
            $customHeaders
    ...
    public static function listing(
        ...
        array $params = [],
        array $customHeaders = []
    ): BunqResponseNoteAttachmentRequestResponseList {
        $apiClient = new ApiClient(static::getApiContext());
    ...
    public static function get(
        ...
        int $monetaryAccountId = null,
        array $customHeaders = []
    ): BunqResponseNoteAttachmentRequestResponse {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->get(
            vsprintf(
