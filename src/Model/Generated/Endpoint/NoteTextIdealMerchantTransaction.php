...
class NoteTextIdealMerchantTransaction extends BunqModel
{
     ...
     */
    public static function create(int $idealMerchantTransactionId, int $monetaryAccountId = null, string  $content = null, array $customHeaders = []): BunqResponseInt
    {
     ...
     * @return BunqResponseInt
     */
    public static function update(int $idealMerchantTransactionId, int $noteTextIdealMerchantTransactionId, int $monetaryAccountId = null, string  $content = null, array $customHeaders = []): BunqResponseInt
    {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->put(
            vsprintf(
                self::ENDPOINT_URL_UPDATE,
                [static::determineUserId(), static::determineMonetaryAccountId($monetaryAccountId), $idealMerchantTransactionId, $noteTextIdealMerchantTransactionId]
            ),
            [self::FIELD_CONTENT => $content],
            $customHeaders
        );
     ...
     */
    public static function delete(int $idealMerchantTransactionId, int $noteTextIdealMerchantTransactionId, int $monetaryAccountId = null, array $customHeaders = []): BunqResponseNull
    {
        $apiClient = new ApiClient(static::getApiContext());
     ...
     */
    public static function listing(int $idealMerchantTransactionId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteTextIdealMerchantTransactionList
    {
        $apiClient = new ApiClient(static::getApiContext());
     ...
     */
    public static function get(int $idealMerchantTransactionId, int $noteTextIdealMerchantTransactionId, int $monetaryAccountId = null, array $customHeaders = []): BunqResponseNoteTextIdealMerchantTransaction
    {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->get(
            vsprintf(
