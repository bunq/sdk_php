 ...
 * @generated
 */
class MonetaryAccountExternalSavings extends BunqModel
{
    /**
     * Endpoint constants.
     */
    const ENDPOINT_URL_CREATE = 'user/%s/monetary-account-external-savings';
    const ENDPOINT_URL_READ = 'user/%s/monetary-account-external-savings/%s';
    const ENDPOINT_URL_UPDATE = 'user/%s/monetary-account-external-savings/%s';
    const ENDPOINT_URL_LISTING = 'user/%s/monetary-account-external-savings';
     ...
     * Object type.
     */
    const OBJECT_TYPE_GET = 'MonetaryAccountExternalSavings';
    ...
    /**
     * The description of the MonetaryAccountExternalSavings. Defaults to 'bunq
     * account'.
     *
     * @var string
     */
    ...
    /**
     * The daily spending limit Amount of the MonetaryAccountExternalSavings.
     * Defaults to 1000 EUR. Currency must match the
     * MonetaryAccountExternalSavings's currency. Limited to 10000 EUR.
     *
     * @var Amount
     */
    ...
    /**
     * The status of the MonetaryAccountExternalSavings. Ignored in POST
     * requests (always set to ACTIVE) can be CANCELLED or PENDING_REOPEN in PUT
     * requests to cancel (close) or reopen the MonetaryAccountExternalSavings.
     * When updating the status and/or sub_status no other fields can be updated
    ...
    /**
     * The optional free-form reason for voluntarily cancelling (closing) the
     * MonetaryAccountExternalSavings. Can be any user provided message. Should
    ...
    /**
     * @param string $currency The currency of the
     * MonetaryAccountExternalSavings as an ISO 4217 formatted currency code.
     * @param string $service The service the MonetaryAccountExternalSavings is
     * connected with.
     ...
     * MonetaryAccountExternalSavings.
     * @param string|null $status The status of the
     * MonetaryAccountExternalSavings. Ignored in POST requests (always set to
     * ACTIVE) can be CANCELLED or PENDING_REOPEN in PUT requests to cancel
     * (close) or reopen the MonetaryAccountExternalSavings. When updating the
     * status and/or sub_status no other fields can be updated in the same
     * request (and vice versa).
     * @param string|null $subStatus The sub-status of the
     * MonetaryAccountExternalSavings providing extra information regarding the
     ...
     * (closing) the MonetaryAccountExternalSavings, can only be OTHER. Should
     * only be specified if updating the status to CANCELLED.
     * @param string|null $reasonDescription The optional free-form reason for
     * voluntarily cancelling (closing) the MonetaryAccountExternalSavings. Can
     * be any user provided message. Should only be specified if updating the
     * status to CANCELLED.
     ...
     */
    public function __construct(string  $currency, string  $service, string  $description = null, Amount  $dailyLimit = null, string  $avatarUuid = null, string  $status = null, string  $subStatus = null, string  $reason = null, string  $reasonDescription = null, string  $displayName = null, MonetaryAccountSetting  $setting = null, Amount  $savingsGoal = null)
    {
...
self::FIELD_SAVINGS_GOAL => $savingsGoal],
    ...
    /**
     * @param int $monetaryAccountExternalSavingsId
     * @param string[] $customHeaders
     *
     * @return BunqResponseMonetaryAccountExternalSavings
     */
    public static function get(int $monetaryAccountExternalSavingsId, array $customHeaders = []): BunqResponseMonetaryAccountExternalSavings
    {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->get(
            vsprintf(
                self::ENDPOINT_URL_READ,
                [static::determineUserId(), $monetaryAccountExternalSavingsId]
            ),
            [],
            $customHeaders
        );

        return BunqResponseMonetaryAccountExternalSavings::castFromBunqResponse(
     ...
     * @return BunqResponseInt
     */
    public static function update(int $monetaryAccountExternalSavingsId, string  $description = null, Amount  $dailyLimit = null, string  $avatarUuid = null, string  $status = null, string  $subStatus = null, string  $reason = null, string  $reasonDescription = null, string  $displayName = null, MonetaryAccountSetting  $setting = null, Amount  $savingsGoal = null, array $customHeaders = []): BunqResponseInt
    {
        $apiClient = new ApiClient(static::getApiContext());
...
self::FIELD_SAVINGS_GOAL => $savingsGoal],
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseMonetaryAccountExternalSavingsList
     */
    public static function listing( array $params = [], array $customHeaders = []): BunqResponseMonetaryAccountExternalSavingsList
    {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->get(
            vsprintf(
        ...
        return BunqResponseMonetaryAccountExternalSavingsList::castFromBunqResponse(
