 ...
 * @generated
 */
class NoteTextWhitelistResult extends BunqModel
{
    /**
     * Endpoint constants.
     */
    const ENDPOINT_URL_CREATE = 'user/%s/monetary-account/%s/whitelist/%s/whitelist-result/%s/note-text';
    const ENDPOINT_URL_UPDATE = 'user/%s/monetary-account/%s/whitelist/%s/whitelist-result/%s/note-text/%s';
    const ENDPOINT_URL_DELETE = 'user/%s/monetary-account/%s/whitelist/%s/whitelist-result/%s/note-text/%s';
    const ENDPOINT_URL_LISTING = 'user/%s/monetary-account/%s/whitelist/%s/whitelist-result/%s/note-text';
    const ENDPOINT_URL_READ = 'user/%s/monetary-account/%s/whitelist/%s/whitelist-result/%s/note-text/%s';
     ...
     * @param int $whitelistId
     * @param int $whitelistResultId
     * @param int $noteTextWhitelistResultId
     * @param int|null $monetaryAccountId
     * @param string|null $content The content of the note.
     * @param string[] $customHeaders
     *
    ...
    public static function listing(int $whitelistId, int $whitelistResultId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteTextWhitelistResultList
    {
        ...
        return BunqResponseNoteTextWhitelistResultList::castFromBunqResponse(
    ...
    public static function get(int $whitelistId, int $whitelistResultId, int $noteTextWhitelistResultId, int $monetaryAccountId = null, array $customHeaders = []): BunqResponseNoteTextWhitelistResult
    {
        ...
        return BunqResponseNoteTextWhitelistResult::castFromBunqResponse(
