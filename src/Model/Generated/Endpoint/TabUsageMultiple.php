...
class TabUsageMultiple extends BunqModel
{
     ...
     * endpoint.
     */
    public function __construct(string  $description, string  $status, Amount  $amountTotal, bool  $allowAmountHigher = null, bool  $allowAmountLower = null, bool  $wantTip = null, int  $minimumAge = null, string  $requireAddress = null, string  $redirectUrl = null, TabVisibility  $visibility = null, string  $expiration = null, array  $tabAttachment = null)
    {
     ...
     */
    public static function create(int $cashRegisterId, string  $description, string  $status, Amount  $amountTotal, int $monetaryAccountId = null, bool  $allowAmountHigher = null, bool  $allowAmountLower = null, bool  $wantTip = null, int  $minimumAge = null, string  $requireAddress = null, string  $redirectUrl = null, TabVisibility  $visibility = null, string  $expiration = null, array  $tabAttachment = null, array $customHeaders = []): BunqResponseString
    {
...
self::FIELD_TAB_ATTACHMENT => $tabAttachment],
     ...
     * @return BunqResponseString
     */
    public static function update(int $cashRegisterId, string $tabUsageMultipleUuid, int $monetaryAccountId = null, string  $status = null, Amount  $amountTotal = null, TabVisibility  $visibility = null, string  $expiration = null, array  $tabAttachment = null, array $customHeaders = []): BunqResponseString
    {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->put(
            vsprintf(
                self::ENDPOINT_URL_UPDATE,
                [static::determineUserId(), static::determineMonetaryAccountId($monetaryAccountId), $cashRegisterId, $tabUsageMultipleUuid]
            ),
            [self::FIELD_STATUS => $status,
self::FIELD_AMOUNT_TOTAL => $amountTotal,
self::FIELD_VISIBILITY => $visibility,
...
self::FIELD_TAB_ATTACHMENT => $tabAttachment],
     ...
     */
    public static function delete(int $cashRegisterId, string $tabUsageMultipleUuid, int $monetaryAccountId = null, array $customHeaders = []): BunqResponseNull
    {
        $apiClient = new ApiClient(static::getApiContext());
     ...
     */
    public static function get(int $cashRegisterId, string $tabUsageMultipleUuid, int $monetaryAccountId = null, array $customHeaders = []): BunqResponseTabUsageMultiple
    {
        $apiClient = new ApiClient(static::getApiContext());
     ...
     */
    public static function listing(int $cashRegisterId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseTabUsageMultipleList
    {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->get(
            vsprintf(
