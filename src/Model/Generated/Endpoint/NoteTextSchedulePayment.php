...
class NoteTextSchedulePayment extends BunqModel
{
     ...
     */
    public static function create(int $schedulePaymentId, int $monetaryAccountId = null, string  $content = null, array $customHeaders = []): BunqResponseInt
    {
     ...
     * @return BunqResponseInt
     */
    public static function update(int $schedulePaymentId, int $noteTextSchedulePaymentId, int $monetaryAccountId = null, string  $content = null, array $customHeaders = []): BunqResponseInt
    {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->put(
            vsprintf(
                self::ENDPOINT_URL_UPDATE,
                [static::determineUserId(), static::determineMonetaryAccountId($monetaryAccountId), $schedulePaymentId, $noteTextSchedulePaymentId]
            ),
            [self::FIELD_CONTENT => $content],
            $customHeaders
        );
     ...
     */
    public static function delete(int $schedulePaymentId, int $noteTextSchedulePaymentId, int $monetaryAccountId = null, array $customHeaders = []): BunqResponseNull
    {
        $apiClient = new ApiClient(static::getApiContext());
     ...
     */
    public static function listing(int $schedulePaymentId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteTextSchedulePaymentList
    {
        $apiClient = new ApiClient(static::getApiContext());
     ...
     */
    public static function get(int $schedulePaymentId, int $noteTextSchedulePaymentId, int $monetaryAccountId = null, array $customHeaders = []): BunqResponseNoteTextSchedulePayment
    {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->get(
            vsprintf(
