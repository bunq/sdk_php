...
class NoteAttachmentSofortMerchantTransaction extends BunqModel
{
    ...
    public static function update(
        int $sofortMerchantTransactionId,
        int $noteAttachmentSofortMerchantTransactionId,
        int $monetaryAccountId = null,
        string $description = null,
        array $customHeaders = []
    ): BunqResponseInt {
    ...
    public static function listing(
        ...
        array $params = [],
        array $customHeaders = []
    ): BunqResponseNoteAttachmentSofortMerchantTransactionList {
        $apiClient = new ApiClient(static::getApiContext());
    ...
    public static function get(
        ...
        int $monetaryAccountId = null,
        array $customHeaders = []
    ): BunqResponseNoteAttachmentSofortMerchantTransaction {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->get(
            vsprintf(
