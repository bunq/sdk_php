 ...
 * @generated
 */
class NoteTextScheduleRequestBatch extends BunqModel
{
    /**
     * Endpoint constants.
     */
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseNoteTextScheduleRequestBatchList
     */
    public static function listing(int $scheduleRequestInquiryBatchId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteTextScheduleRequestBatchList
    {
        $apiClient = new ApiClient(static::getApiContext());
        ...
        return BunqResponseNoteTextScheduleRequestBatchList::castFromBunqResponse(
