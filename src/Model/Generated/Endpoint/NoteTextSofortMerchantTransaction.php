...
class NoteTextSofortMerchantTransaction extends BunqModel
{
     ...
     */
    public static function create(int $sofortMerchantTransactionId, int $monetaryAccountId = null, string  $content = null, array $customHeaders = []): BunqResponseInt
    {
     ...
     * @return BunqResponseInt
     */
    public static function update(int $sofortMerchantTransactionId, int $noteTextSofortMerchantTransactionId, int $monetaryAccountId = null, string  $content = null, array $customHeaders = []): BunqResponseInt
    {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->put(
            vsprintf(
                self::ENDPOINT_URL_UPDATE,
                [static::determineUserId(), static::determineMonetaryAccountId($monetaryAccountId), $sofortMerchantTransactionId, $noteTextSofortMerchantTransactionId]
            ),
            [self::FIELD_CONTENT => $content],
            $customHeaders
        );
     ...
     */
    public static function delete(int $sofortMerchantTransactionId, int $noteTextSofortMerchantTransactionId, int $monetaryAccountId = null, array $customHeaders = []): BunqResponseNull
    {
        $apiClient = new ApiClient(static::getApiContext());
     ...
     */
    public static function listing(int $sofortMerchantTransactionId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteTextSofortMerchantTransactionList
    {
        $apiClient = new ApiClient(static::getApiContext());
     ...
     */
    public static function get(int $sofortMerchantTransactionId, int $noteTextSofortMerchantTransactionId, int $monetaryAccountId = null, array $customHeaders = []): BunqResponseNoteTextSofortMerchantTransaction
    {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->get(
            vsprintf(
