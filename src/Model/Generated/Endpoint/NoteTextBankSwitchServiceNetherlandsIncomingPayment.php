 ...
 * @generated
 */
class NoteTextBankSwitchServiceNetherlandsIncomingPayment extends BunqModel
{
    /**
     * Endpoint constants.
     */
     ...
     */
    public static function listing(int $switchServicePaymentId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteTextBankSwitchServiceNetherlandsIncomingPaymentList
    {
        $apiClient = new ApiClient(static::getApiContext());
        ...
        return BunqResponseNoteTextBankSwitchServiceNetherlandsIncomingPaymentList::castFromBunqResponse(
