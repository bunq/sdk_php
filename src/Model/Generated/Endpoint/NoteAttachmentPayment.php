 ...
 * @generated
 */
class NoteAttachmentPayment extends BunqModel
{
    /**
     * Endpoint constants.
     */
    const ENDPOINT_URL_CREATE = 'user/%s/monetary-account/%s/payment/%s/note-attachment';
    const ENDPOINT_URL_UPDATE = 'user/%s/monetary-account/%s/payment/%s/note-attachment/%s';
    const ENDPOINT_URL_DELETE = 'user/%s/monetary-account/%s/payment/%s/note-attachment/%s';
    const ENDPOINT_URL_LISTING = 'user/%s/monetary-account/%s/payment/%s/note-attachment';
    const ENDPOINT_URL_READ = 'user/%s/monetary-account/%s/payment/%s/note-attachment/%s';
...
self::FIELD_ATTACHMENT_ID => $attachmentId],
    ...
    /**
     * @param int $paymentId
     * @param int $noteAttachmentPaymentId
     * @param int|null $monetaryAccountId
     * @param string|null $description Optional description of the attachment.
     * @param string[] $customHeaders
     *
    ...
    public static function listing(int $paymentId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteAttachmentPaymentList
    {
        ...
        return BunqResponseNoteAttachmentPaymentList::castFromBunqResponse(
    ...
    public static function get(int $paymentId, int $noteAttachmentPaymentId, int $monetaryAccountId = null, array $customHeaders = []): BunqResponseNoteAttachmentPayment
    {
        ...
        return BunqResponseNoteAttachmentPayment::castFromBunqResponse(
